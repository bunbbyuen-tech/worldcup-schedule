...
- [x] 加時／十二碼賽果支援（2026-07-14）：完場比數顯示加時後最終比數＋「（加時）」「（十二碼 X-Y）」註記；鬼腳圖勝方判斷、卡片綠色標示、冠軍行喺加時／十二碼決勝時全部正確（之前只讀 90 分鐘比數，和波場次斷唔到勝方）
- [x] 時區第一格改返 Sheffield（2026-07-14，Nam 旅行完返到；旅行期間曾用歐洲 CET）
